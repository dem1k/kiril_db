...
<div class="add">
    <a href="/gifts/create/"> <input type="submit" value="  " /> </a></div>
<div class="clr"></div>
<div class="table">
    <table id ="datatable" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td>
                <a href="/gifts/edit/<?=$object->id?>/"><img src="/assets/html/images/edit.png" width="32" height="30" /></a>
                <a href="/gifts/delete/<?=$object->id?>/"><img src="/assets/html/images/trash.png" width="32" height="30" /></a>
            </td>
        </tr>
            <?php endforeach;?>
        <?php else:?>
