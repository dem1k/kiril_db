...
<div class="table">
    <table id ="datatable" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td>
                <a href="/jobs/edit/<?=$object->id?>/"><img src="/assets/html/images/edit.png" width="32" height="30" /></a>
                <a href="/jobs/delete/<?=$object->id?>/"><img src="/assets/html/images/trash.png" width="32" height="30" /></a>
            </td>
        </tr>
            <?php endforeach;?>
        <?php else:?>
